...
//       'The state of a MenuAnchor should not change.',
//     );
//     return false;
//   }
// }
...
//     );
//     properties.add(
//       DiagnosticsProperty<FocusNode?>('focusNode', childFocusNode),
//     );
...
//       _internalMenuController = widget.controller != null
//           ? MenuController()
//           : null;
//     }
//   }
...
//       reservedPadding:
//           widget.reservedPadding ?? const EdgeInsets.all(_kMenuViewPadding),
//     );
//   }
...
//     );
//     properties.add(
//       DiagnosticsProperty<MenuSerializableShortcut?>(
//         'shortcut',
//         shortcut,
//         defaultValue: null,
//       ),
...
//       _internalMenuController = (oldWidget.controller == null)
//           ? null
//           : MenuController();
//     }
//   }
...
//               _isHovered = true;
//               widget.onHover?.call(true);
//               final _MenuAnchorState root = _MenuAnchorState._maybeOf(
//                 context,
//               )!._root;
...
//               // it.
//               if (root._orientation == Axis.horizontal &&
...
//     assert(
//       _debugMenuInfo('${intent.direction}: Invoking directional focus intent.'),
//     );
...
//       final String acceleratorCharacter = _displayLabel[_acceleratorIndex]
//           .toLowerCase();
//       _shortcutRegistryEntry = _shortcutRegistry
...
//       Offset desiredPosition = alignment
...
//     T? resolve<T>(
//       WidgetStateProperty<T>? Function(MenuStyle? style) getProperty,
//     ) {
...
//     final Color? backgroundColor = resolve<Color?>(
//       (MenuStyle? style) => style?.backgroundColor,
//     );
//     final Color? shadowColor = resolve<Color?>(
//       (MenuStyle? style) => style?.shadowColor,
//     );
//     final Color? surfaceTintColor = resolve<Color?>(
//       (MenuStyle? style) => style?.surfaceTintColor,
//     );
//     final double elevation =
//         resolve<double?>((MenuStyle? style) => style?.elevation) ?? 0;
//     final Size? minimumSize = resolve<Size?>(
//       (MenuStyle? style) => style?.minimumSize,
//     );
//     final Size? fixedSize = resolve<Size?>(
//       (MenuStyle? style) => style?.fixedSize,
//     );
//     final Size? maximumSize = resolve<Size?>(
//       (MenuStyle? style) => style?.maximumSize,
//     );
//     final BorderSide? side = resolve<BorderSide?>(
//       (MenuStyle? style) => style?.side,
//     );
...
//       Axis.horizontal ||
//       null => (MenuBarTheme.of(context).style, _MenuBarDefaultsM3(context)),
//       Axis.vertical => (MenuTheme.of(context).style, _MenuDefaultsM3(context)),
//     };
//     T? effectiveValue<T>(T? Function(MenuStyle? style) getProperty) {
...
//     final AlignmentGeometry alignment = effectiveValue(
//       (MenuStyle? style) => style?.alignment,
//     )!;
//     final EdgeInsetsGeometry padding =
//         resolve<EdgeInsetsGeometry?>((MenuStyle? style) => style?.padding) ??
//         EdgeInsets.zero;
...
//       consumeOutsideTaps:
//           anchor._root._menuController.isOpen &&
...
//                 controller: anchor._menuController,
//               ),
//             },
//             child: Shortcuts(
//               shortcuts: _kMenuTraversalShortcuts,
...
//                 avoidBounds: DisplayFeatureSubScreen.avoidBounds(
//                   mediaQuery,
//                 ).toSet(),
